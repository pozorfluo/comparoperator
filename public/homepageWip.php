...
<div class="container-fluid">
    ...
    <a class="navbar-brand" href="#">
        <img src="images/icons/logo.png" width="30" height="30" alt="">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item">
            <a class="nav-link disabled text-primary" href="#">Disabled</a>
        </li>
        </ul>
        <form class="form-inline my-2 my-lg-0">
        <input class="form-control mr-sm-2 text-muted" type="search" placeholder="Search" aria-label="Search">
        <button class="btn btn-outline-secondary my-2 my-sm-0 text-secondary" type="submit">Search</button>
        </form>
    </div>
    </nav>
    ...
    <div class="col-sm-5">
        <div class="card">
        <img class="card-img-top rounded" src="images/destinations/0001.jpg" width=250px height=250px alt="One to">
        <div class="card-body">
  ...
  <div class="card-body">
    ...
    <footer class="page-footer font-small text-dark bg-white">
    ...
    <div class="row text-center d-flex justify-content-center pt-4 mb-2">
        ...
        <h6 class="text-uppercase font-weight-bold">
            <a href="#!" class="text-primary">Products</a>
        </h6>
        </div>
        <!-- Grid column -->
        ...
        <div class="col-md-2 mb-3">
        <h6 class="text-uppercase font-weight-bold">
            <a href="#!" class="text-primary">Awards</a>
        </h6>
        </div>
        <!-- Grid column -->
